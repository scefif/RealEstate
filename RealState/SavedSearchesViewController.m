...
//    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Message" message:@"Currently You Don't Have Any Saved Searches" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
//    [alert show];
